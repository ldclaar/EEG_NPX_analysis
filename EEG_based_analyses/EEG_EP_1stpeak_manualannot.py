...
def get_annotation():
    valid = True
    while valid:
        annotation = input("Enter your annotation, is there a 1st peak: ")
...
def load_EEGexp_data(file_path):
    ...
    annotations_file_path = os.path.join(exp.data_folder, 'manual_first_peak_detection.npy')
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Plot EPs and annotate 1st peak presence.")
