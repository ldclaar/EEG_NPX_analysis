...
probes_csv_file = Path(r"C:\Users\lesliec\OneDrive - Allen Institute\Shared Documents - Lab 328\Projects\CL-CM stim\CLstimpilot_03192025_probescoords.csv")
...
screenshot_name = r"CLstimpilot_03262025_probes_sag"
show_regions = True
target_regions = ['CL', 'CM']
other_regions = ['TH', 'STR', 'HIP', 'MB', 'ACA', 'ILA', 'PL', 'MO', 'SS', 'VIS'] #, 'CP', 'AV', 'HIP']
...
for indi, probe_info in choose_df.iterrows():
    ...
    # scene.add(Line(BR_coords, color='k', alpha=0.9, linewidth=3, name=probe_info.probe))
...
## Display the figure. ##
scene.render(interactive=False, camera='sagittal', zoom=1.5)
